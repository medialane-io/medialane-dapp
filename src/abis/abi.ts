/** DEPRECATED: alias of ipCollectionAbi. New code must import from '@/abis/ip_collection'. */
/** This file is kept only because use-nft-details.ts still references it (and that hook is broken — it calls ERC-721 methods on the registry). */
export const abi = [
  {
    "type": "impl",
