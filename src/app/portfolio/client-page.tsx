    ...
    return (
        <div className="min-h-screen">
            <main className="">
                ...
                {!address && (
                    <div className="text-center py-12 layout-px">
                        ...
                        <div className="space-y-12 w-full">
                            ...
                            {loading ? (
                                ...
                                <div className="space-y-16 pb-16">
                                    ...
                                    <div className="pt-8 border-t border-border/10 flex justify-between items-center bg-m3-surface-container-low rounded-2xl p-6 mx-6 sm:mx-10 lg:mx-16">
                                        <div>
