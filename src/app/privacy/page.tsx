    ...
    <div className="container mx-auto px-4 pt-12 pb-16 max-w-3xl space-y-10">
      ...
      <div className="space-y-8">
        <Section num="1" title="Information We Collect">
          ...
          authentication session via StarknetKit. We do not store your private keys — they
          are managed client-side by StarknetKit&apos;s infrastructure.</p>
        ...
        <Section num="4" title="Data Sharing">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li><strong className="text-foreground">StarknetKit</strong> — our wallet infrastructure provider</li>
