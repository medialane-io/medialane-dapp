...
const PILLARS = [
  ...
  },
  {
    ...
    description:
      "Powered by StarknetKit and Starknet's account abstraction, Medialane removes the friction of gas fees and seed phrases. Sign in with email, mint, trade, and earn — without ever touching a crypto wallet.",
  },
  {
    icon: Globe,
    ...
    <div className="container mx-auto px-4 pt-12 pb-16 max-w-4xl space-y-14">
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground leading-relaxed">
          ...
          with wallet derivation via <strong className="text-foreground">StarknetKit</strong> —
