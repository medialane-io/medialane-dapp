...
const FAQS = [
  {
    ...
    a: "Sign in with your email or social account. Medialane automatically creates a Starknet wallet for you via StarknetKit — no browser extension or seed phrase required. You'll be prompted to set a PIN during onboarding.",
  },
  {
